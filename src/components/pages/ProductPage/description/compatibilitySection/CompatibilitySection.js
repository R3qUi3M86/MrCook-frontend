        ...
        <section className="section pt-2 pt-md-5">
            <div className="container">
                ...
                <div className="row text-center">
                    <p className="mainSectionTitle mb-0">Cooking unleashed!</p>
                    <div className="d-flex justify-content-center">
                ...
                <div className="row">
                    <div className="col-md-4 px-5 pt-3 pt-md-0">
                        ...
                        <div className="row text-center">
                            <p className="subSectionTitle my-1">OVEN BAKE</p>
                        </div>
                        <p className="descriptionText">&emsp;&emsp;MrCook can be safely used in electrical ovens. It's dimensions are
                    ...
                    <div className="col-md-4 px-5 pt-3 pt-md-0">
                        ...
                        <div className="row text-center">
                            <p className="subSectionTitle my-1">USE IN MICROWAVE</p>
                        </div>
                        <p className="descriptionText">&emsp;&emsp;Your MrCook can be safely used in microwave oven. Extensive testing has proven that 
                    ...
                    <div className="col-md-4 px-5 pt-3 pt-md-0">
                        ...
                        <div className="row text-center">
                            <p className="subSectionTitle my-1">EASY CLEAN</p>
                        </div>
                        <p className="descriptionText">&emsp;&emsp;No more heaps of dirty dishes. MrCook is all in one - cooking bowl, ovenware, tableware, eating plate
